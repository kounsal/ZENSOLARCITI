...
import "../../src/custom styles/home.css";
  ...
  return (
    <>
            ...
            >
              <div className="icon-box  ">
                ...
                <p className="custom-font">
                  Zen Solarciti Lights Your Path to a Cleaner, Brighter Future.
                  Choose Sustainable Energy, Safeguarding Our Planet for
                  Generations to Come.
                </p>
              </div>
            </div>
      ...
      <section
        id="models"
        className="models"
        style={{ background: "#F68E3C", paddingBottom: "100px" }}
      >
        <div className="container" data-aos="fade-up">
            ...
            <div className="col-lg-5 d-flex align-items-stretch">
              <div className="info">
                <div className="address">
                  ...
                  <h4>Location:</h4>
                  <p>177 Huntington Ave, Boston, Massachusetts 02115, US</p>
                </div>
                <div className="email">
                  <i class="fa-solid fa-envelope"></i>
                  <h4>Email:</h4>
                  <p>
                    <a mailto="admin@zensolarciti.com">
                      admin@zensolarciti.com
                    </a>
                  </p>
                </div>
                <div className="phone">
